...
/**
* GraphStream_Example_08 is a example of GraphStream library
...
* javac -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_08.java
* <p>
* Comand for execution in Unix is:
* java -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_08
* <p>
...
* @date       2023-June-12
*/
public class GraphStream_Example_08 {

	public static void main(String args[]) {
		new GraphStream_Example_08();
	}
	
	public GraphStream_Example_08() {

		System.setProperty("org.graphstream.ui", "swing");
		
		Graph graph = new SingleGraph("GraphStream_Example_08");
		...
		graph.addEdge("AQ", "A", "Q",true);
		graph.addEdge("AP", "A", "P",true);
