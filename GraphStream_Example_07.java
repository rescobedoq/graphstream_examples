...
/**
* GraphStream_Example_07 is a example of GraphStream library
...
* javac -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_07.java
* <p>
* Comand for execution in Unix is:
* java -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_07
* <p>
...
* @date       2023-June-12
*/
public class GraphStream_Example_07 {
	
	public static void main(String args[]) {

		System.setProperty("org.graphstream.ui", "swing");
		
		Graph graph = new SingleGraph("GraphStream_Example_07");
		...
		Edge AQ = graph.addEdge("AQ", "A", "Q",true);
		graph.addEdge("AP", "A", "P",false);

		System.out.println(AQ.isDirected());
