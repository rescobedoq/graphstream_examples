...
/**
* GraphStream_Example_04 is a example of GraphStream library
...
* javac -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_04.java
* <p>
* Comand for execution in Unix is:
* java -classpath .:gs-core-2.0.jar:gs-ui-swing-2.0.jar GraphStream_Example_04
* <p>
...
* @date       2023-June-12
*/
public class GraphStream_Example_04 {
	
	public static void main(String args[]) {

		System.setProperty("org.graphstream.ui", "swing");
		
		Graph graph = new SingleGraph("GraphStream_Example_04");
		...
		Q.setAttribute("ui.label", Q.getId());
		P.setAttribute("ui.label", P.getId());
